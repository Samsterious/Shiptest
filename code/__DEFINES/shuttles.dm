...
#define SHUTTLE_DWIDTH_TOO_LARGE "our vessel's width offset (dwidth) is too large for this port's bounds"
#define SHUTTLE_WIDTH_TOO_LARGE "our vessel's width is too large for this port's bounds"
#define SHUTTLE_DHEIGHT_TOO_LARGE "our vessel's height offset (dheight) is too large for this port's bounds"
#define SHUTTLE_HEIGHT_TOO_LARGE "our vessel's height is too large for this port's bounds"
#define SHUTTLE_ALREADY_DOCKED "vessel is already docked on this port"
#define SHUTTLE_SOMEONE_ELSE_DOCKED "another vessel is already docked on this port"
#define SHUTTLE_PORT_DISABLED "docking port is disabled"
#define SHUTTLE_TOUCHES_EDGE "the landing area overlaps with map border"
#define SHUTTLE_OUR_MOBILEDOCK_FORBIDS_DOCKING "our mobile docking port is docked with something; forbidding docking"
#define SHUTTLE_TARGET_MOBILEDOCK_FORBIDS_DOCKING "target's mobile docking port is docked with something; forbidding docking on this particular port"
#define SHUTTLE_PORT_IS_ADJUSTING "adjustable port is in the middle of adjusting itself for another vessel to land"
#define SHUTTLE_ADJUSTABLE_OUR_HEIGHT_TOO_LARGE "adjustable port's zone height is not large enough for our vessel"
#define SHUTTLE_ADJUSTABLE_OUR_WIDTH_TOO_LARGE "adjustable port's zone width is not large enough for our vessel"
